<script>
    ...
    function addToCart(productData){ 
        ...
        // cart datai item find korar jonne 
            ...
            cartItems.forEach(function(item) {
                ...
                <tr>
                        ...
                        <td class="cart-product-image">
                            <a href="#"><img src="${item.image ? item.image : App.baseUrl+'/assets/asset/img/No Product Image.png'}" alt="Product Image"></a>
                        </td>
            ...
            cartItems.forEach(function(item) {
                ...
                <div class="mini-cart-item d-flex align-items-center border-bottom mb-3">
                        <div class="mini-cart-img me-3">
                            <a href="#">
                            <img src="${item.image ? item.image : App.baseUrl+'/assets/asset/img/No Product Image.png'}" alt="Image" class="img-fluid rounded-start" style="width: 80px; height: 80px;">
                            </a>
